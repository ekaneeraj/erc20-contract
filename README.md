...
1. Address: 0x36858aA15d2761a19639953F7848857bEBf05164
2. Explorer link: [Link](https://sepolia.etherscan.io/address/0x36858aA15d2761a19639953F7848857bEBf05164)
...
```
git clone https://github.com/ekaneeraj/erc20-contract
cd erc20-contract
forge build
```
...
```
forge script script/DeployERC20Token.s.sol --rpc-url $SEPOLIA_RPC_URL --private-key $PRIVATE_KEY --broadcast --verify --etherscan-api-key $ETHERSCAN_API_KEY
```
...
```bash
forge script script/DeployERC20Token.s.sol --rpc-url $SEPOLIA_RPC_URL --account defaultKey --sender <Wallet Address> --broadcast`
```
